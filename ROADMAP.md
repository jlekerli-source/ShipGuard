...
- Add a ShipGuard-native spec-driven workflow inspired by Spec Kit's constitution/spec/plan/tasks/analyze loop and CodexPro-style MCP bridge guardrails, without vendoring external code or weakening ShipGuard's local proof, redaction, and read-only product-QA boundaries.
