...
Only a passing `v4 stable-publication` report with public GitHub release metadata, downloaded or supplied public release assets, tag/manifest freshness, and post-release consumer proof from those assets can support a stable-v4 claim.
