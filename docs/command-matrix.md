...
| Audit external workflow sources | `ios external-audit` | ShipGuard-native source inputs, capability matrix, replacement ledger, implementation backlog, license boundary, and report-quality questions for Spec Kit, CodexPro, Expo, native iOS workflow, and other sources |
