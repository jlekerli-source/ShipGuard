...
| Normalize agent task traces | `agent trace`, `codex trace` | ShipGuard TraceBridge: prompt, tool-call, receipt, verify verdict, next-action, runtime-receipt, and worker-budget timeline |
