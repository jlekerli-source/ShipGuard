...
| Audit iOS design quality | `ios design` | ShipGuard VibeCheck: app-type inference, `designTailoring`, design DNA, ShipGuard-native motion quality gates, haptics, preview routing, and ImageGen icon handoff |
...
| Redact or evaluate iOS reports | `ios redact`, `ios report-quality`, `ios eval`, `ios demo` | Redacted local reports, shareable report-usefulness scoring with performance runtime-evidence, explanation, severity, proof-boundary, grouping, first-experiment, validation-route, and stop-condition checks, priority actions, actionability questions, fixture candidates, generated and consumed promotion manifests for materialized synthetic fixtures, materialized-fixture recursion guards, deterministic behavior evals, and clean first-run demo |
