...
| Verify a Codex task result | `verify` | `shipguard-verdict.json` and Markdown with changed files, scope checks, evidence checks, rejected overclaims, pass/review/blocked status, and next exact action |
