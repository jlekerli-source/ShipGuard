...
| Audit iOS modernization and system exposure | `ios modernize`, `ios app-intelligence`, `ios ai-readiness` | ShipGuard UpgradeForge, ShipGuard SignalLens, and ShipGuard ModelDock reports with bounded source-scan evidence, optional ShipGuard-only eval boundaries, and shareable path-safe output |
