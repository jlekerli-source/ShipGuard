...
| Prove v4 stable publication | `v4 stable-publication` | ShipGuard V4 Stable Publication Proof: public GitHub release metadata, stable-v4 release notes, LaunchKey candidate packet proof, downloaded release assets, post-release consumer proof, independent adoption evidence, final security-review evidence, blocked claims, scope boundary, report-quality questions, and result UX before a stable-v4 release claim |
