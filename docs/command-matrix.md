...
| Prove v4 release-candidate readiness | `v4 release-candidate` | ShipGuard V4 Release Candidate Readiness / LaunchKey: fresh install, upgrade, uninstall, release proof consumption, external adoption packet, final schema docs, plugin refresh proof, release-readiness commands, blocked claims, and report-quality questions without claiming stable v4 product release |
