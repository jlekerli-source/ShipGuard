...
| Plan web work from first-audit evidence | `web plan` | ShipGuard WebForge: scoped web tasks, validation commands, read-only validation receipts, stop conditions, and report-quality questions from a WebScan report |
...
| Plan backend work from first-audit evidence | `backend plan` | ShipGuard ServiceForge: scoped backend tasks, validation commands, read-only validation receipts, stop conditions, and report-quality questions from a ServiceRadar report |
...
| Plan CLI work from first-audit evidence | `cli plan` | ShipGuard CommandForge: scoped CLI contract tasks, smoke commands, read-only validation receipts, stop conditions, and report-quality questions from a CommandLens report |
