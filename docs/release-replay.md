...
gh release download v3.8.0 \
  --pattern 'codex-maintainer-v3.8.0.tar.gz' \
  --pattern 'release-manifest.json' \
  --pattern 'release-index.json' \
  --pattern 'proof-ledger.md' \
  --dir /tmp/codex-maintainer-v3.8.0

./bin/codex-maintainer release-replay verify \
  --manifest /tmp/codex-maintainer-v3.8.0/release-manifest.json \
  --tarball /tmp/codex-maintainer-v3.8.0/codex-maintainer-v3.8.0.tar.gz \
  --index /tmp/codex-maintainer-v3.8.0/release-index.json \
  --ledger /tmp/codex-maintainer-v3.8.0/proof-ledger.md \
  --out /tmp/codex-maintainer-v3.8.0/replay
```
