...
The action requires a `release-url` because replay verification and attestation are meant to bind artifact proof to a public release page. Use the predictable tag URL before publishing, then verify the final release after upload.
