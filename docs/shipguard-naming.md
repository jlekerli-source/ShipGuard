...
| `shipguard v4 release-candidate` | ShipGuard V4 Release Candidate Readiness / LaunchKey | Prove install, upgrade, uninstall, release-consume, adoption packet, final schema docs, and plugin refresh readiness without claiming stable v4 release. |
