...
| `shipguard v4 release-candidate` | ShipGuard V4 Release Candidate Readiness / LaunchKey | Prove install, optional package-tarball fresh-install proof, optional same-prefix upgrade proof, optional rollback cleanup proof, release-consume, optional downloaded release-asset proof, generated archive-member screening, blocking-proof result UX, adoption packet, final schema docs, and plugin refresh readiness without claiming stable v4 release. |
