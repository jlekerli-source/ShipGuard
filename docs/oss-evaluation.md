...
- `shipguard ios external-audit` to convert Spec Kit, CodexPro, Expo, native iOS workflow skills, X posts, and other external ideas into a native replacement ledger before ShipGuard claims adoption.
