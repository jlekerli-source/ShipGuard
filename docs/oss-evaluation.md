...
A follow-up read-only receipt-quality pass showed the next weakness: weak `ios build-apps` receipt reports generated fixture candidates, but report-quality ranked a generic front-door question first and classified receipt gaps as performance or preview fixture types. Receipt gaps now rank ahead of generic build-apps questions, and report-quality emits `ios-build-apps-receipt-quality-fixture` candidates backed by a public synthetic fixture in `fixtures/ios-report-quality/build-apps-receipts`.
