...
For CI, use `jlekerli-source/ringly-codex-workflows/actions/release-consume@v3.30.0` to download the assets, run this verification, upload the consumer proof bundle, and fail the job when proof is invalid. Use `jlekerli-source/ringly-codex-workflows/actions/release-evidence@v3.30.0` afterward when you want a static HTML evidence artifact.

Download the release assets from GitHub:

```bash
mkdir -p /tmp/codex-maintainer-v3.30.0
...
- `/tmp/codex-maintainer-v3.30.0/consumer-proof/consumer-report.json`
- `/tmp/codex-maintainer-v3.30.0/consumer-proof/consumer-report.md`
- `/tmp/codex-maintainer-v3.30.0/consumer-proof/asset-digests.json`
- `/tmp/codex-maintainer-v3.30.0/consumer-proof/asset-digests.md`
- `/tmp/codex-maintainer-v3.30.0/consumer-proof/replay/replay-report.json`
- `/tmp/codex-maintainer-v3.30.0/consumer-proof/replay/replay-report.md`
- `/tmp/codex-maintainer-v3.30.0/consumer-proof/attestation/attestation.json`
- `/tmp/codex-maintainer-v3.30.0/consumer-proof/attestation/attestation.md`
- `/tmp/codex-maintainer-v3.30.0/consumer-proof/attestation/attestation-badge.json`
...
./bin/codex-maintainer release-evidence site \
  ...
  --out /tmp/codex-maintainer-v3.30.0/evidence-site
```
...
./bin/codex-maintainer release-evidence bundle \
  ...
  --out /tmp/codex-maintainer-v3.30.0-evidence-bundle \
  --version 3.30.0
```
...
- `attestation-badge.json` says `pass v3.30.0`.
