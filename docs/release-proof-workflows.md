...
- calls `jlekerli-source/ringly-codex-workflows/actions/release-proof@v3.8.0`
...
For local proof generation without GitHub Actions, use `codex-maintainer release-proof build`.
