...
```bash
./bin/shipguard codex trace --trace /tmp/codex-trace.json --xcodebuildmcp-evidence /tmp/xcodebuildmcp-proof --out /tmp/shipguard-codex-trace --shipguard-eval --shareable
```
