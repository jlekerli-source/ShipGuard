...
./bin/codex-maintainer release-manifest \
  --tarball dist/codex-maintainer-v3.17.0.tar.gz \
...
./bin/codex-maintainer release-index build \
  ...
  --manifest dist/release-proof-v3.17.0/release-manifest.json \
...
./bin/codex-maintainer release-replay verify \
  --manifest /tmp/codex-maintainer-release-proof/release-manifest.json \
  --tarball /tmp/codex-maintainer-release-assets/codex-maintainer-v3.17.0.tar.gz \
...
./bin/codex-maintainer release-diff compare \
  ...
  --right /tmp/codex-maintainer-v3.17.0 \
...
./bin/codex-maintainer release-evidence site \
  --consume /tmp/codex-maintainer-v3.17.0/consumer-proof \
...
The command writes `index.html`, `evidence-index.json`, `README.md`, and copied site exports under `sites/`. See `release-evidence-index.md`.
