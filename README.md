...
- `docs/v4-stable-publication.md`: final stable-v4 publication proof from public release metadata, release notes, downloaded assets, post-release consumer proof, independent adoption evidence, and final security-review evidence.
...
| Prove v4 stable publication | `./bin/shipguard v4 stable-publication --help` |
...
- `scripts/tool_value_gauntlet.py`: the ShipGuard Tool Value Gauntlet for grading every command, skill, plugin, action, doc, and proof path for real developer usefulness, running representative commands, every public command help path, skill/plugin receipts, workflow chains, scenario failure/remediation, fresh package adoption, PilotBench receipts, Domain Pack SDK receipts, configuration-baseline receipts, full-audit receipts, unified inspect receipts, concise result-UX receipts, v4 preview stabilization receipts, v4 schema-freeze receipts, v4 release-candidate readiness receipts, v4 product-release stabilization receipts, and stable-publication command coverage before probing the weakest next workflow layer.
...
- `scripts/v4_stable_publication.py`: ShipGuard V4 Stable Publication Proof, the read-only final gate for public GitHub release metadata, stable-v4 release notes, LaunchKey candidate packet proof, downloaded release assets, post-release consumer proof, independent adoption evidence, final security-review evidence, and blocked stable claims.
