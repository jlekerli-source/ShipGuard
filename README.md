...
| `shipguard lean debt ...` | Harvest `ponytail:` and `shipguard-lean:` shortcut markers into marker-visibility and rot-risk reviews with ceilings, upgrade-trigger status, exact next actions, and no fake benchmark-savings claims. |
