...
| `shipguard lean debt ...` | Harvest `ponytail:` and `shipguard-lean:` shortcut markers into a marker-visibility review with ceilings, upgrade-trigger status, and no fake benchmark-savings claims. |
