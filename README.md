...
- `docs/v4-release-candidate.md`: v4 release-candidate readiness for install, optional package-tarball fresh-install proof, upgrade, uninstall, release proof consumption, optional downloaded release-asset consumer proof, adoption packet, schema docs, and plugin refresh proof.
...
- `scripts/v4_release_candidate.py`: ShipGuard V4 Release Candidate Readiness / LaunchKey, the read-only readiness report for fresh install, optional package-tarball install proof, upgrade, uninstall, release proof consumption, optional downloaded release-asset consumer proof, external adoption packet, final schema docs, plugin refresh proof, and stable-v4 blocked claims.
