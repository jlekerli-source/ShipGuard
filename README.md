...
| `shipguard lean review --mode ultra ...` | Review the current diff before merge with a current-diff-only decision map, delete/simplify subset, runnable-check proof rows, and whole-repo non-claim. |
