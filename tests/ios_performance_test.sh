...
grep -q '"resultUX":' "$tmp_dir/performance/ios-performance.json"
grep -q '"proofSource":' "$tmp_dir/performance/ios-performance.json"
grep -q '"nextCommand":' "$tmp_dir/performance/ios-performance.json"
...
grep -q '## Result' "$tmp_dir/performance/ios-performance.md"
