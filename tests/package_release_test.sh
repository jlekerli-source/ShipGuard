...
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-verify-can-verify-reject-unsupported-completi-bfc3a617/README.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-verify-can-verify-reject-unsupported-completi-bfc3a617/fixture-candidate.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-verify-can-verify-reject-unsupported-completi-bfc3a617/fixture-report.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-verify-can-verify-reject-unsupported-completi-bfc3a617/fixture-report.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-prepare-identify-notification-per-1faa952e/README.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-prepare-identify-notification-per-1faa952e/fixture-candidate.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-prepare-identify-notification-per-1faa952e/fixture-report.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-prepare-identify-notification-per-1faa952e/fixture-report.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-verify-require-permission-state-a-aa77287a/README.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-verify-require-permission-state-a-aa77287a/fixture-candidate.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-verify-require-permission-state-a-aa77287a/fixture-report.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-verify-require-permission-state-a-aa77287a/fixture-report.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-the-verdict-separate-simulator-de-62c1ca4a/README.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-the-verdict-separate-simulator-de-62c1ca4a/fixture-candidate.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-the-verdict-separate-simulator-de-62c1ca4a/fixture-report.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-prepare-did-the-verdict-separate-simulator-de-62c1ca4a/fixture-report.md$" "$tar_list"
grep -q "^$package_name/docs/lean-audit.md$" "$tar_list"
grep -q "^$package_name/docs/action-verify-pr.md$" "$tar_list"
grep -q "^$package_name/scripts/action_verify_pr.py$" "$tar_list"
grep -q "^$package_name/scripts/lean_audit.py$" "$tar_list"
grep -q "^$package_name/scripts/lean_review.py$" "$tar_list"
grep -q "^$package_name/scripts/lean_debt.py$" "$tar_list"
grep -q "^$package_name/scripts/lean_gain.py$" "$tar_list"
grep -q "^$package_name/tests/lean_audit_test.sh$" "$tar_list"
grep -q "^$package_name/fixtures/lean-audit-demo/package.json$" "$tar_list"
grep -q "^$package_name/fixtures/lean-audit-demo/diffs/overbuilt-widget.diff$" "$tar_list"
...
grep -q "^$package_name/fixtures/lean-audit-demo/src/ThinWrapper.ts$" "$tar_list"
grep -q "^$package_name/fixtures/lean-audit-demo/src/PluginBridge.ts$" "$tar_list"
grep -q "^$package_name/fixtures/action-verify-pr/configured.yml$" "$tar_list"
grep -q "^$package_name/fixtures/action-verify-pr/broken.yml$" "$tar_list"
grep -q "^$package_name/fixtures/action-verify-pr/runtime-artifact/shipguard-verdict.json$" "$tar_list"
grep -q "^$package_name/fixtures/action-verify-pr/runtime-artifact/shipguard-verdict.md$" "$tar_list"
grep -q "^$package_name/fixtures/action-verify-pr/runtime-broken/shipguard-verdict.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-it-block-missing-task-d-aad0ce94/README.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-it-block-missing-task-d-aad0ce94/fixture-candidate.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-it-block-missing-task-d-aad0ce94/fixture-report.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-it-block-missing-task-d-aad0ce94/fixture-report.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-the-report-tell-a-fresh-9fdb2055/README.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-the-report-tell-a-fresh-9fdb2055/fixture-candidate.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-the-report-tell-a-fresh-9fdb2055/fixture-report.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-the-report-tell-a-fresh-9fdb2055/fixture-report.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/02-shipguard-action-verify-pr-does-the-freshmaintainerfail-0c0f8769/README.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/02-shipguard-action-verify-pr-does-the-freshmaintainerfail-0c0f8769/fixture-candidate.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/02-shipguard-action-verify-pr-does-the-freshmaintainerfail-0c0f8769/fixture-report.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/02-shipguard-action-verify-pr-does-the-freshmaintainerfail-0c0f8769/fixture-report.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-when-a-runtime-artifact-is-c-c950c6b0/README.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-when-a-runtime-artifact-is-c-c950c6b0/fixture-candidate.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-when-a-runtime-artifact-is-c-c950c6b0/fixture-report.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-action-verify-pr-when-a-runtime-artifact-is-c-c950c6b0/fixture-report.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-lean-audit-should-this-recurring-lean-code-ob-f228f086/README.md$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-lean-audit-should-this-recurring-lean-code-ob-f228f086/fixture-candidate.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-lean-audit-should-this-recurring-lean-code-ob-f228f086/fixture-report.json$" "$tar_list"
grep -q "^$package_name/fixtures/ios-report-quality/01-shipguard-lean-audit-should-this-recurring-lean-code-ob-f228f086/fixture-report.md$" "$tar_list"
...
grep -q "^$package_name/tests/action_verify_pr_test.sh$" "$tar_list"
...
grep -q "^$package_name/tests/expo_readiness_test.sh$" "$tar_list"
...
grep -q "^$package_name/fixtures/expo-sdk56-demo/package.json$" "$tar_list"
grep -q "^$package_name/fixtures/expo-sdk56-demo/app.json$" "$tar_list"
grep -q "^$package_name/fixtures/expo-sdk56-demo/eas.json$" "$tar_list"
grep -q "^$package_name/fixtures/expo-sdk56-demo/app/index.tsx$" "$tar_list"
...
grep -q "^$package_name/.agents/skills/expo-readiness/SKILL.md$" "$tar_list"
grep -q "^$package_name/.agents/skills/professional-design-qa/SKILL.md$" "$tar_list"
...
grep -q '| shipguard expo readiness --help | pass |' "$tmp_dir/package-self-audit/self-audit.md"
...
grep -q '| scripts/expo_readiness.py | pass |' "$tmp_dir/package-self-audit/self-audit.md"
...
grep -q '| scripts/action_verify_pr.py | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| scripts/codex_marketplace_readiness.py | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| scripts/lean_audit.py | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| scripts/lean_review.py | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| scripts/lean_debt.py | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| scripts/lean_gain.py | pass |' "$tmp_dir/package-self-audit/self-audit.md"
...
grep -q '| docs/action-verify-pr.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
...
grep -q '| tests/action_verify_pr_test.sh | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/action-verify-pr/configured.yml | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/action-verify-pr/broken.yml | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/action-verify-pr/runtime-artifact/shipguard-verdict.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/action-verify-pr/runtime-artifact/shipguard-verdict.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/action-verify-pr/runtime-broken/shipguard-verdict.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-verify-can-verify-reject-unsupported-completi-bfc3a617/README.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-verify-can-verify-reject-unsupported-completi-bfc3a617/fixture-candidate.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-verify-can-verify-reject-unsupported-completi-bfc3a617/fixture-report.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-verify-can-verify-reject-unsupported-completi-bfc3a617/fixture-report.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-prepare-identify-notification-per-1faa952e/README.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-prepare-identify-notification-per-1faa952e/fixture-candidate.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-prepare-identify-notification-per-1faa952e/fixture-report.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-prepare-identify-notification-per-1faa952e/fixture-report.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-verify-require-permission-state-a-aa77287a/README.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-verify-require-permission-state-a-aa77287a/fixture-candidate.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-verify-require-permission-state-a-aa77287a/fixture-report.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-verify-require-permission-state-a-aa77287a/fixture-report.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-the-verdict-separate-simulator-de-62c1ca4a/README.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-the-verdict-separate-simulator-de-62c1ca4a/fixture-candidate.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-the-verdict-separate-simulator-de-62c1ca4a/fixture-report.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-prepare-did-the-verdict-separate-simulator-de-62c1ca4a/fixture-report.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-the-report-tell-a-fresh-9fdb2055/README.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-the-report-tell-a-fresh-9fdb2055/fixture-candidate.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-the-report-tell-a-fresh-9fdb2055/fixture-report.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-action-verify-pr-does-the-report-tell-a-fresh-9fdb2055/fixture-report.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/02-shipguard-action-verify-pr-does-the-freshmaintainerfail-0c0f8769/README.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/02-shipguard-action-verify-pr-does-the-freshmaintainerfail-0c0f8769/fixture-candidate.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/02-shipguard-action-verify-pr-does-the-freshmaintainerfail-0c0f8769/fixture-report.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/02-shipguard-action-verify-pr-does-the-freshmaintainerfail-0c0f8769/fixture-report.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-action-verify-pr-when-a-runtime-artifact-is-c-c950c6b0/README.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-action-verify-pr-when-a-runtime-artifact-is-c-c950c6b0/fixture-candidate.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-action-verify-pr-when-a-runtime-artifact-is-c-c950c6b0/fixture-report.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-action-verify-pr-when-a-runtime-artifact-is-c-c950c6b0/fixture-report.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-lean-audit-should-this-recurring-lean-code-ob-f228f086/README.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-lean-audit-should-this-recurring-lean-code-ob-f228f086/fixture-candidate.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-lean-audit-should-this-recurring-lean-code-ob-f228f086/fixture-report.json | pass |' "$tmp_dir/package-self-audit/self-audit.md"
grep -q '| fixtures/ios-report-quality/01-shipguard-lean-audit-should-this-recurring-lean-code-ob-f228f086/fixture-report.md | pass |' "$tmp_dir/package-self-audit/self-audit.md"
...
grep -q 'shipguard expo readiness' "$package_root/docs/cli.md"
...
grep -q "Current checkout package artifact before version bump: dist/shipguard-v$version.tar.gz" "$tmp_dir/package-next-goal.md"
grep -q 'Expected package artifact after release bump: dist/shipguard-v2.6.0.tar.gz' "$tmp_dir/package-next-goal.md"
