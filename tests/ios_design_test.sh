...
grep -q '"proofAction":' "$tmp_dir/design/ios-design.json"
grep -q '"requiredPrinciples":' "$tmp_dir/design/ios-design.json"
grep -q '"preview proof"' "$tmp_dir/design/ios-design.json"
grep -q 'Proof action' "$tmp_dir/design/ios-design.md"
grep -q 'Finding Proof Actions' "$tmp_dir/design/ios-design.md"
grep -q 'Success condition' "$tmp_dir/design/ios-design.md"
grep -q 'Failure meaning' "$tmp_dir/design/ios-design.md"
