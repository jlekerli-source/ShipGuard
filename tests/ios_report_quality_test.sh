...
if "notification and permission workflow" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered notification permission value-gauntlet question as priority: {priority!r}")
PY
