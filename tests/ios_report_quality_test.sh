...
if "profile-native validation receipts" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered profile-native validation value-gauntlet question as priority: {priority!r}")
PY
