...
if "scenario-remediation receipts" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered scenario-remediation receipt value-gauntlet question as priority: {priority!r}")
PY
