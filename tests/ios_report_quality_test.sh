...
if "command-family runtime-output receipts" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered command-family runtime-output value-gauntlet question as priority: {priority!r}")
PY
