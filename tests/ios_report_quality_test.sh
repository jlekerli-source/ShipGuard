...
if "Claude, Gemini, Cursor" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered universal agent packaging question as priority: {priority!r}")
PY
