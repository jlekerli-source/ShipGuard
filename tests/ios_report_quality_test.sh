...
if "adoption receipts" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered adoption receipt value-gauntlet question as priority: {priority!r}")
PY
