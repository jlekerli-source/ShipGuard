...
if "profile-native fix-plan receipts" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered profile-native fix-plan value-gauntlet question as priority: {priority!r}")
PY
