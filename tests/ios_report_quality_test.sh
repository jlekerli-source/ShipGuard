...
if "full-audit orchestrator" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered full-audit orchestrator question as priority: {priority!r}")
PY
