...
grep -q '"case_count": 9' "$tmp_dir/arena/results.json"
grep -q '"average_total": 6.67' "$tmp_dir/arena/results.json"
grep -q '"high_risk_finding_count": 8' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_cases": 4' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_ratio": 0.44' "$tmp_dir/arena/results.json"
