...
test -f "$tmp_dir/arena/runs/data-migration-loss-regression/report.json"
...
grep -q '"case_count": 16' "$tmp_dir/arena/results.json"
grep -q '"average_total": 4.69' "$tmp_dir/arena/results.json"
grep -q '"high_risk_finding_count": 21' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_cases": 5' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_ratio": 0.31' "$tmp_dir/arena/results.json"
grep -q '"validation_quality_average": 0.62' "$tmp_dir/arena/results.json"
grep -q '"scope_control_average": 1.06' "$tmp_dir/arena/results.json"
...
grep -q '"id": "data-migration-loss-regression"' "$tmp_dir/arena/results.json"
...
grep -q '| data-migration-loss-regression | 1/12 | 2 | false | do not merge until high-risk findings are resolved |' "$tmp_dir/arena/index.md"
