...
grep -q '"case_count": 12' "$tmp_dir/arena/results.json"
grep -q '"average_total": 6.00' "$tmp_dir/arena/results.json"
grep -q '"high_risk_finding_count": 12' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_cases": 5' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_ratio": 0.42' "$tmp_dir/arena/results.json"
grep -q '"validation_quality_average": 0.83' "$tmp_dir/arena/results.json"
grep -q '"scope_control_average": 1.25' "$tmp_dir/arena/results.json"
