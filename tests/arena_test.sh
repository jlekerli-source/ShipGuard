...
grep -q '"case_count": 3' "$tmp_dir/arena/results.json"
grep -q '"average_total": 5.00' "$tmp_dir/arena/results.json"
grep -q '"high_risk_finding_count": 4' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_cases": 1' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_ratio": 0.33' "$tmp_dir/arena/results.json"
grep -q '"scope_control_average": 1.00' "$tmp_dir/arena/results.json"
