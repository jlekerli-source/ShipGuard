...
grep -q '"case_count": 13' "$tmp_dir/arena/results.json"
grep -q '"average_total": 5.62' "$tmp_dir/arena/results.json"
grep -q '"high_risk_finding_count": 14' "$tmp_dir/arena/results.json"
...
grep -q '"validation_quality_average": 0.77' "$tmp_dir/arena/results.json"
grep -q '"scope_control_average": 1.23' "$tmp_dir/arena/results.json"
