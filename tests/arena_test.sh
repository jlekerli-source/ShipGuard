...
grep -q '"case_count": 8' "$tmp_dir/arena/results.json"
grep -q '"average_total": 6.25' "$tmp_dir/arena/results.json"
grep -q '"high_risk_finding_count": 8' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_cases": 3' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_ratio": 0.38' "$tmp_dir/arena/results.json"
