...
grep -q './tests/full_audit_test.sh' "$tmp_dir/NEXT_GOAL.md"
grep -q './tests/inspect_test.sh' "$tmp_dir/NEXT_GOAL.md"
grep -q './tests/concise_verdict_result_ux_test.sh' "$tmp_dir/NEXT_GOAL.md"
