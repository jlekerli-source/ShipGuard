...
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-consume@v3.30.0' "$workflow"
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-diff@v3.30.0' "$workflow"
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-evidence@v3.30.0' "$workflow"
grep -q 'previous-tag:' "$workflow"
grep -q 'release-tag:' "$workflow"
grep -q 'default: v3.22.0' "$workflow"
grep -q 'default: v3.30.0' "$workflow"
grep -q 'contents: read' "$workflow"
grep -q 'include-diff: auto' "$workflow"
grep -q 'build-index: true' "$workflow"
grep -q 'mode: fail' "$workflow"

grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-evidence@v3.30.0' "$bundle_workflow"
...
grep -q 'default: v3.30.0' "$bundle_workflow"
