...
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-consume@v3.22.0' "$workflow"
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-diff@v3.22.0' "$workflow"
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-evidence@v3.22.0' "$workflow"
grep -q 'previous-tag:' "$workflow"
grep -q 'release-tag:' "$workflow"
grep -q 'default: v3.21.0' "$workflow"
...
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-evidence@v3.22.0' "$bundle_workflow"
...
grep -q 'default: v3.21.0' "$bundle_workflow"
