...
grep -q '"average_total": 4.69' "$tmp_dir/leaderboard.json"
grep -q '"high_risk_finding_count": 21' "$tmp_dir/leaderboard.json"
...
grep -q '"task_id": "data-migration-loss-regression"' "$tmp_dir/leaderboard.json"
