...
grep -q 'name: Verify ShipGuard release proof' "$action"
...
grep -q "| shipguard-v$version.tar.gz | release tarball | true | present |" "$tmp_dir/consumer-proof/asset-digests.md"
