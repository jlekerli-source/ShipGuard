...
grep -q '"caseCount": 13' "$tmp_dir/shipguard-eval/ios-shipguard-eval.json"
...
grep -q '"mode": "brand-audit"' "$tmp_dir/shipguard-eval/ios-shipguard-eval.json"
grep -q '"mode": "shipyard-value-audit"' "$tmp_dir/shipguard-eval/ios-shipguard-eval.json"
...
grep -q '| brand-deck-vibey-renaming | pass | brand-audit |' "$tmp_dir/shipguard-eval/ios-shipguard-eval.md"
grep -q '| shipyard-tool-value-gauntlet | pass | shipyard-value-audit |' "$tmp_dir/shipguard-eval/ios-shipguard-eval.md"
