...
grep -q '"surfaceCount": 64' "$tmp_dir/brand/ios-branding.json"
grep -q '"surfaceName": "ShipGuard V4 Release Candidate Readiness"' "$tmp_dir/brand/ios-branding.json"
grep -q '"codename": "launchkey"' "$tmp_dir/brand/ios-branding.json"
...
surface_names=(
  ...
  "ShipGuard WebScan"
  "ShipGuard WebForge"
  "ShipGuard ServiceRadar"
  "ShipGuard ServiceForge"
  "ShipGuard CommandLens"
