...
- Source question: Does stable-publication keep accepted external evidence source classes, actor/reviewer relationships, and rejected substitutes visible so weak substitutes cannot be mistaken for adoption or security proof?
...
- Copy-ready claim: ShipGuard source-class fixture coverage is promoted; stable-v4 publication is still blocked until real evidence passes.
...
## External Evidence Artifact Redaction

| Evidence | Required Artifact Fields | Accepted Artifact Proof | Rejected Artifact Proof | Blocked Substitute | Pass Boundary |
| --- | --- | --- | --- | --- | --- |
| `independent-adoption-evidence` | commands, artifacts, privateDataRedacted, outcome, nonClaims | redacted public logs, redacted screenshots, public issue or PR links, public release-consume output | local absolute paths, private screenshots, tokens or account identifiers, unreviewed app-specific notes, missing artifact links | private unredacted maintainer artifacts | Adoption proof requires redacted/public command and artifact evidence with privateDataRedacted=true plus outcome and non-claims. |
| `final-security-review-evidence` | methodology, commands, artifacts, privateDataRedacted, findingsSummary, nonClaims | redacted security-review report, public checklist output, redacted scanner output, reviewed issue or PR links | vague self-review notes, local absolute paths, private screenshots, tokens or account identifiers, missing methodology | unredacted or provenance-free security notes | Security proof requires reviewed stable-v4 surfaces, methodology, redacted artifacts, findings summary, and no open critical/high findings. |

Non-claims:

- Artifact-redaction fixture coverage is not independent adoption evidence.
- Artifact-redaction fixture coverage is not final security-review evidence.
- Artifact-redaction fixture coverage does not prove stable-v4 publication.
