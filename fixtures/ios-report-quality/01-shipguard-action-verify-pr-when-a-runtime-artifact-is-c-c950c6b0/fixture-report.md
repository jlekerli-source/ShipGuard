...
- Source question: When a runtime artifact is consumable, does the report give the reviewer a concrete decision, proof-to-attach list, and failure meaning instead of a vague status note?
