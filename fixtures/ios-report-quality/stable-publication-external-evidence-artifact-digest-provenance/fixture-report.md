...
- Source question: Does stable-publication require external adoption and security-review artifacts to include digest or public/source provenance instead of only naming artifact files?
...
## External Evidence Artifact Digest Provenance

| Evidence | Required Artifact Proof | Accepted Provenance | Rejected Artifact Proof | Blocked Substitute | Pass Boundary |
| --- | --- | --- | --- | --- | --- |
| `independent-adoption-evidence` | artifactName, sha256 or digest, sourceUrl or sourceCommand, privateDataRedacted, capturedAt | public release-consume output with sha256, public issue or PR link with command transcript, redacted external user install log with digest | filename only, local absolute path only, private screenshot without digest, missing source command, missing capturedAt | artifact names without digest or public/source provenance | Adoption proof artifacts must include a digest or public/source provenance plus redaction and outcome fields. |
| `final-security-review-evidence` | artifactName, sha256 or digest, reviewSource, methodology, privateDataRedacted, capturedAt | redacted security report with sha256, public checklist output with source command, scanner output with capturedAt and digest | filename only, vague self-review note, private screenshot without digest, missing methodology, missing review source | security notes that name artifacts but omit digest or review-source provenance | Security proof artifacts must include digest or review-source provenance plus methodology, redaction, and findings summary. |

Non-claims:

- Artifact digest/provenance fixture coverage is not independent adoption evidence.
- Artifact digest/provenance fixture coverage is not final security-review evidence.
- Artifact digest/provenance fixture coverage does not prove stable-v4 publication.
