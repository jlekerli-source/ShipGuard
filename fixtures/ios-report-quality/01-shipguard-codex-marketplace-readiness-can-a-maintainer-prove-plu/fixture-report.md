...
- Type: `shipguard-marketplace-readiness-fixture`
- Source question: Can a maintainer prove plugin install freshness from tracked source, local marketplace, and strict status output?
