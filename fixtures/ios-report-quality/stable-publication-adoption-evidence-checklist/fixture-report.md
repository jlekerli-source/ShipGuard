...
- Source question: Does stable-publication reject weak adoption signals and require independent actor, commands, artifacts, redaction, outcome, and non-claims before stable-v4 release?
...
- Does stable-publication reject weak adoption signals and require independent actor, commands, artifacts, redaction, outcome, and non-claims before stable-v4 release?
...
## Adoption Weak Signal Rejection

- Weak signals rejected: GitHub stars, GitHub forks, download counts, generated starter files, maintainer-only private app runs, and vague testimonials without artifacts.
- Required independent evidence: actorRelationship `independent`, commands, artifacts, outcome, nonClaims, and privateDataRedacted `true`.
- Stable-v4 release remains blocked until the adoption record has an independent actor plus command output, artifact links, redaction confirmation, outcome, and non-claims.
...
- Privacy boundary: GitHub downloads, generated starters, and maintainer-only runs do not count as independent adoption.
- Current diagnostics: weak adoption signals rejected; actorRelationship must be `independent`; privateDataRedacted must be `true`.
