...
required_files=(
  ...
  "fixtures/arena/generated-artifact-cleanup-bypass/diff.patch"
  "fixtures/arena/generated-artifact-cleanup-bypass/run.md"
  "fixtures/arena/generated-artifact-cleanup-bypass/task.md"
  "fixtures/arena/github-posting-without-dry-run/diff.patch"
  "fixtures/arena/github-posting-without-dry-run/run.md"
  "fixtures/arena/github-posting-without-dry-run/task.md"
  ...
  "fixtures/arena/release-asset-trust-bypass/diff.patch"
  "fixtures/arena/release-asset-trust-bypass/run.md"
  "fixtures/arena/release-asset-trust-bypass/task.md"
  "fixtures/arena/security-token-leakage/diff.patch"
  "fixtures/arena/security-token-leakage/run.md"
  "fixtures/arena/security-token-leakage/task.md"
  "fixtures/arena/data-migration-loss-regression/diff.patch"
  "fixtures/arena/data-migration-loss-regression/run.md"
  "fixtures/arena/data-migration-loss-regression/task.md"
  "fixtures/arena/storekit-entitlement-regression/diff.patch"
  "fixtures/arena/storekit-entitlement-regression/run.md"
  "fixtures/arena/storekit-entitlement-regression/task.md"
  ...
  "fixtures/ios-report-quality/materialized-external-audit/README.md"
  "fixtures/ios-report-quality/materialized-external-audit/fixture-candidate.json"
  "fixtures/ios-report-quality/materialized-external-audit/fixture-report.json"
  "fixtures/ios-report-quality/materialized-external-audit/fixture-report.md"
  "fixtures/ios-report-quality/value-gauntlet-actionability/README.md"
  "fixtures/ios-report-quality/value-gauntlet-actionability/fixture-candidate.json"
  "fixtures/ios-report-quality/value-gauntlet-actionability/fixture-report.json"
  "fixtures/ios-report-quality/value-gauntlet-actionability/fixture-report.md"
  ...
  "tests/ios_external_audit_test.sh"
