...
SURFACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "codename": "launchkey",
        "plainPurpose": "Prove install, optional package-tarball fresh-install proof, upgrade, uninstall, release-consume, optional downloaded release-asset proof, adoption packet, final schema docs, and plugin refresh readiness before calling v4 candidate-ready.",
