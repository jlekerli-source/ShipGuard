...
def build_stable_publication_evidence_starter_kit_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "publicProofWalkthrough": {
            ...
            "consumerProofQuickstart": [
                "gh release download v<version> --repo <owner/repo> --dir <downloaded-release-assets-dir>",
                "./bin/shipguard release-consume verify --dir <downloaded-release-assets-dir> --out <consumer-proof-dir> --version <version>",
                "./bin/shipguard v4 stable-publication --path . --out <stable-publication-dir> --github-release-repo <owner/repo> --release-version <version> --release-candidate-report <v4-release-candidate-json-or-dir> --release-assets <downloaded-release-assets-dir> --external-adoption-evidence <adoption-evidence-json-or-dir> --security-review-evidence <security-review-json-or-dir> --shipguard-eval --shareable",
            ],
            "nonClaims": [
                ...
                "Consumer proof proves public asset replay, not independent adoption or final security review.",
...
def write_stable_publication_evidence_starter_kit(
    ...
    *,
    ...
    readme_lines = [
        ...
        "## Evidence Ladder",
        "",
        "- Public consumer proof: you can produce this yourself from public release assets by installing and verifying the released package. This proves public consumability, not adoption.",
        "- Private maintainer QA: Ringly, Ilmify, or other maintainer app runs are useful ShipGuard product QA. They do not count as independent adoption evidence.",
        "- Independent adoption evidence: requires a non-maintainer user, repo, issue, PR, or redacted external install report.",
        "- Final security-review evidence: requires a review record covering ShipGuard's CLI, plugin, GitHub Actions, release proof, package install, and redaction/privacy surfaces with no open critical or high findings.",
        "",
    ...
    walkthrough_lines = [
        ...
        "",
        "Download the public assets first:",
        "",
        "```bash",
        "gh release download v<version> --repo <owner/repo> --dir <downloaded-release-assets-dir>",
        "```",
        "",
        "Then verify the downloaded packet:",
        "",
        "```bash",
        "./bin/shipguard release-consume verify --dir <downloaded-release-assets-dir> --out <consumer-proof-dir> --version <version>",
        "```",
        "",
        "Then rerun stable-publication with the same downloaded assets and completed external evidence records:",
        "",
        "```bash",
        "./bin/shipguard v4 stable-publication --path . --out <stable-publication-dir> --github-release-repo <owner/repo> --release-version <version> --release-candidate-report <v4-release-candidate-json-or-dir> --release-assets <downloaded-release-assets-dir> --external-adoption-evidence <adoption-evidence-json-or-dir> --security-review-evidence <security-review-json-or-dir> --shipguard-eval --shareable",
        "```",
        "",
        "This proves that a normal consumer can verify the public package. It does not prove adoption or final security review.",
        "",
