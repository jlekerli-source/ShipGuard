...
PROFILE_CONFIG: dict[str, dict[str, Any]] = {
    "web": {
        ...
        "firstCommands": [
            ...
            "shipguard web plan --report /tmp/shipguard-web-audit --target . --out /tmp/shipguard-web-plan --shareable",
    ...
    "backend": {
        ...
        "firstCommands": [
            ...
            "shipguard backend plan --report /tmp/shipguard-backend-audit --target . --out /tmp/shipguard-backend-plan --shareable",
    ...
    "cli": {
        ...
        "firstCommands": [
            ...
            "shipguard cli plan --report /tmp/shipguard-cli-audit --target . --out /tmp/shipguard-cli-plan --shareable",
