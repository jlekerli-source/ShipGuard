...
- Status: pass
- VERSION: 3.148.0
- Expected next release from VERSION: v3.149.0
- Planned target release: v3.148.0
- Current checkout package artifact: dist/shipguard-v3.148.0.tar.gz
- Release package artifact to build: dist/shipguard-v3.148.0.tar.gz
- Action: VERSION already names v3.148.0; build, verify, publish, and consume dist/shipguard-v3.148.0.tar.gz before generating the next goal.
...
6. Build `dist/shipguard-v3.148.0.tar.gz`, create release `v3.148.0`, upload the rebuilt tarball, and consume release proof.
