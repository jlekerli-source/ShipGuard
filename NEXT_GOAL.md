...
- Generated: 2026-06-22T23:43:11Z
- Current toolkit version: 3.138.0
- Target release: v3.138.0
- Title: Stable Publication Asset Repair Handoff

## Version Lineage Check

- Status: pass
- VERSION: 3.138.0
- Expected next release from VERSION: v3.139.0
- Planned target release: v3.138.0
- Current checkout package artifact: dist/shipguard-v3.138.0.tar.gz
- Release package artifact to build: dist/shipguard-v3.138.0.tar.gz
- Action: VERSION already names v3.138.0; build, verify, publish, and consume dist/shipguard-v3.138.0.tar.gz before generating the next goal.
...
- Completed scope: Stable-publication update-release-assets handoffs now use a concrete manual GitHub release asset upload command when verified release asset files are available, while keeping download/supply reruns when assets are missing.
- Evidence: Focused stable-publication tests cover the upload handoff helper, visibility action routing, manual/no-upload boundary, placeholder avoidance with real assets, and existing missing-assets download rerun behavior.

## Following Slash Plan

```text
/plan v3.139.0 Stable Publication Public Release Closure for jlekerli-source/ShipGuard:
...
```text
/goal Implement v3.139.0 Stable Publication Public Release Closure for jlekerli-source/ShipGuard: follow the /plan above, choose one bounded ShipGuard report-quality improvement from ROADMAP.md and docs/oss-evaluation.md, implement it with proof, and generate the next completion receipt plus following /plan and /goal after validation passes.
```

Generate that follow-up file with:

```bash
./bin/shipguard next-goal --release 3.139.0 --title "Stable Publication Public Release Closure" --out NEXT_GOAL.md
```
...
6. Build `dist/shipguard-v3.138.0.tar.gz`, create release `v3.138.0`, upload the rebuilt tarball, and consume release proof.
