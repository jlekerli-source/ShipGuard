...
- Generated: 2026-06-22T17:41:46Z
- Current toolkit version: 3.132.0
- Target release: v3.136.0
- Title: InspectDeck Release-proof Badge Detail
...
1. Implement this bounded improvement: Make InspectDeck expose supplied non-pass release attestation badges and keep the report in review until badge proof is pass or absent.
...
```text
/goal Implement v3.136.0 InspectDeck Release-proof Badge Detail for jlekerli-source/ShipGuard: follow the /plan above, deliver this bounded improvement: Make InspectDeck expose supplied non-pass release attestation badges and keep the report in review until badge proof is pass or absent, push main, verify GitHub Actions, resolve version lineage before publishing any release tarball, verify clean git status, then run shipguard next-goal again for the following release.
```


## Bounded Scope

Make InspectDeck expose supplied non-pass release attestation badges and keep the report in review until badge proof is pass or absent.

## Completion Receipt

- Completed scope: InspectDeck now marks supplied non-pass attestation badges as review, lists badge problems, and routes nextAction/resultUX back to shipguard release-proof build.
...
```text
/goal Implement v3.137.0 InspectDeck Release-proof Path Handoff for jlekerli-source/ShipGuard: follow the /plan above, choose one bounded ShipGuard report-quality improvement from ROADMAP.md and docs/oss-evaluation.md, implement it with proof, and generate the next completion receipt plus following /plan and /goal after validation passes.
```

Generate that follow-up file with:

```bash
./bin/shipguard next-goal --release 3.137.0 --title "InspectDeck Release-proof Path Handoff" --out NEXT_GOAL.md
```
