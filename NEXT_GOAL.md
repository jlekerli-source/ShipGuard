...
- Generated: 2026-06-23T08:21:30Z
- Current toolkit version: 3.171.0
- Target release: v3.172.0
- Title: Diff-first reviewer outcome note-summary polish

## Version Lineage Check

- Status: pass
- VERSION: 3.171.0
- Expected next release from VERSION: v3.172.0
- Planned target release: v3.172.0
- Current checkout package artifact before version bump: dist/shipguard-v3.171.0.tar.gz
- Expected package artifact after release bump: dist/shipguard-v3.172.0.tar.gz
- Action: Before publishing v3.172.0, bump VERSION to 3.172.0, rebuild, and verify dist/shipguard-v3.172.0.tar.gz.

## Slash Plan

```text
/plan v3.172.0 Diff-first reviewer outcome note-summary polish for jlekerli-source/ShipGuard:
...
6. Bump VERSION to 3.172.0, build `dist/shipguard-v3.172.0.tar.gz`, create release `v3.172.0`, and upload the rebuilt tarball.
